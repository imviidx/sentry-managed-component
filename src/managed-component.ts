...
import { ConsentState } from './SentryZarazConsentIntegration';

export default async function (manager: Manager, settings: ComponentSettings) {
  console.log(
    '🎯 [SERVER] Sentry Zaraz Consent Managed Component loading with settings:',
  ...
  manager.addEventListener('clientcreated', ({ client }) => {
    console.log(
      '[Sentry Zaraz Consent MC] Client created, settings:',
      settings
    );

    // Simple hello world to confirm MC is active
    client.execute(
      `console.log("🚀 Hello from Sentry Zaraz Consent Managed Component!")`
    );
    client.execute(
